...
window.SPARK_DESIGN_LAB = {
  ...
  "variants": [
    ...
    },
    {
      ...
      "html": "<div class=\"spark-lab-cardwrap primer-cards\"><div class=\"card acc-rogue\"><div class=\"hdr\"><div class=\"hdr-top\"><span class=\"cap cap-neutral\">Ability</span><span class=\"cap cap-neutral\">Act</span></div><div class=\"hdr-name\">Smoke and Mirrors</div></div><div class=\"cbody\"><div class=\"flv\">Let them argue about what they saw.</div><div class=\"hr\"></div><div class=\"elbl\">Effect</div><div class=\"etxt\">Perform a <strong>Deception</strong> check to plant a false impression — a sound, silhouette, or dropped object.</div><div class=\"csec spark-sec\"><div class=\"clbl\">Spark</div><div class=\"crow\"><div class=\"ci spark-entry spark-entry-inverted\"><div class=\"spark-verb-row\"><span class=\"spark-cost-dies\" title=\"1 Spark\"><span class=\"spark-cost-die\" aria-hidden=\"true\">6</span></span><span class=\"yield-sq cat-def\" aria-hidden=\"true\"></span><span class=\"spark-verb-label\">Obscure</span></div><div class=\"spark-invite-box\">Deflect attention from an Ally</div></div><div class=\"ci spark-entry spark-entry-inverted\"><div class=\"spark-verb-row\"><span class=\"spark-cost-dies\" title=\"2 Sparks\"><span class=\"spark-cost-die\" aria-hidden=\"true\">6</span><span class=\"spark-cost-die\" aria-hidden=\"true\">6</span></span><span class=\"yield-sq cat-def\" aria-hidden=\"true\"></span><span class=\"spark-verb-label\">Pass</span><span class=\"spark-combo-plus\" aria-hidden=\"true\">+</span><span class=\"yield-tri cat-off\" aria-hidden=\"true\"></span><span class=\"spark-verb-label\">Distract</span></div><div class=\"spark-invite-box\">Sell the wrong threat, and then pass your ally through the opening</div></div></div></div></div><div class=\"idtag\">Rogue</div><div class=\"tier-float\"><span>t1</span></div></div></div>",
      "sort": 101
    },
    {
      ...
      "html": "<div class=\"spark-lab-cardwrap primer-cards\"><div class=\"card acc-rogue\"><div class=\"hdr\"><div class=\"hdr-top\"><span class=\"cap cap-neutral\">Ability</span><span class=\"cap cap-neutral\">Act</span></div><div class=\"hdr-name\">Smoke and Mirrors</div></div><div class=\"cbody\"><div class=\"flv\">Let them argue about what they saw.</div><div class=\"hr\"></div><div class=\"elbl\">Effect</div><div class=\"etxt\">Perform a <strong>Deception</strong> check to plant a false impression — a sound, silhouette, or dropped object.</div><div class=\"csec spark-sec\"><div class=\"clbl\">Spark</div><div class=\"crow\"><div class=\"ci spark-entry spark-entry-column-flow\"><div class=\"spark-flow-grid\"><div class=\"spark-flow-vrule\" aria-hidden=\"true\"></div><div class=\"spark-flow-cost\"><span class=\"spark-cost-dies\" title=\"1 Spark\"><span class=\"spark-cost-die\" aria-hidden=\"true\">6</span></span></div><div class=\"spark-flow-pad\" aria-hidden=\"true\"></div><div class=\"spark-flow-lemma\"><span class=\"yield-sq cat-def\" aria-hidden=\"true\"></span><span class=\"spark-flow-verb spark-v-def\">Slip</span></div><div class=\"spark-flow-tail\">your ally through the gap you opened</div></div></div><div class=\"ci spark-entry spark-entry-column-flow\"><div class=\"spark-flow-grid\"><div class=\"spark-flow-vrule\" aria-hidden=\"true\"></div><div class=\"spark-flow-cost\"><span class=\"spark-cost-dies\" title=\"2 Sparks\"><span class=\"spark-cost-die\" aria-hidden=\"true\">6</span><span class=\"spark-cost-die\" aria-hidden=\"true\">6</span></span></div><div class=\"spark-flow-pad\" aria-hidden=\"true\"></div><div class=\"spark-flow-lemma\"><span class=\"yield-tri cat-off\" aria-hidden=\"true\"></span><span class=\"spark-flow-verb spark-v-off\">Sell</span></div><div class=\"spark-flow-tail\">the wrong threat, and then</div><div class=\"spark-flow-lemma\"><span class=\"yield-sq cat-def\" aria-hidden=\"true\"></span><span class=\"spark-flow-verb spark-v-def\">Pass</span></div><div class=\"spark-flow-tail\">your partner through the opening</div></div></div></div></div></div><div class=\"idtag\">Rogue</div><div class=\"tier-float\"><span>t1</span></div></div></div>",
      "sort": 102
    },
    {
      "id": "layout-compact",
